        ...
        <main className="pt-40 pb-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <Link
                to="/linkedin-freebie"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-midnight-blue font-bold rounded-full hover:scale-105 transition-transform"
              >
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-midnight-blue font-bold rounded-full hover:scale-105 transition-transform text-lg shadow-xl mb-8"
            >
              <Download size={24} />
