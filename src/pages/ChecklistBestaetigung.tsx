        ...
        <div className="max-w-2xl mx-auto">
          ...
          {status === 'success' && downloadData && (
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-[#1a1a2e] font-bold text-lg rounded-full hover:scale-105 transition-transform shadow-lg mb-6"
              >
                <Download size={24} />
              ...
              <button
                ...
                className="text-[#D4AF37] hover:text-[#F7E7CE] font-semibold transition-colors"
              >
          ...
          {status === 'expired' && (
            ...
            >
              ...
              <button
                onClick={() => navigate('/wissensbibliothek')}
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-[#1a1a2e] font-bold rounded-full hover:scale-105 transition-transform"
              >
