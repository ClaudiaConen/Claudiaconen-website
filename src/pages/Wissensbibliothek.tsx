                  ...
                  return (
                    <motion.button
                      ...
                      className={`p-4 rounded-xl font-semibold transition-all text-left ${
                        isSelected
                          ? 'bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-midnight-blue shadow-lg'
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 sm:p-6 md:p-8">
                    <div className="flex items-center gap-2 sm:gap-3 text-white/80 text-xs sm:text-sm mb-2 sm:mb-3 flex-wrap">
                      {selectedArticle.category && (
                        <span className="bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-midnight-blue px-2 sm:px-3 py-0.5 sm:py-1 rounded-full font-bold text-xs sm:text-sm">
                          {selectedArticle.category}
                        </span>
                      )}
                      <div className="flex items-center gap-1">
                          ...
                          <div className="flex flex-wrap gap-3">
                            {selectedArticle.call_to_action.links.map((link, idx) => (
                              <a
                                key={idx}
                                href={link.href}
                                className="inline-flex items-center gap-2 px-4 sm:px-5 py-2 text-sm sm:text-base bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-midnight-blue font-semibold rounded-full hover:scale-105 transition-transform shadow-md"
                              >
                                {link.text}
                                <ArrowRight size={16} />
                              </a>
