...
export default function Offers() {
  ...
  return (
    <>
      <section id="offers" className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-midnight-blue via-[#1A2B4C]/60 to-white" aria-labelledby="offers-headline">
