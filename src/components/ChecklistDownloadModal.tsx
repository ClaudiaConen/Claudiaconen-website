          ...
          {isSuccess ? (
            ...
            <>
              <div className="text-center mb-6">
                <div className="mx-auto w-16 h-16 bg-gradient-to-br from-[#D4AF37] to-[#F7E7CE] rounded-full flex items-center justify-center mb-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-gradient-to-r from-[#D4AF37] to-[#F7E7CE] text-white font-bold rounded-lg hover:scale-105 transition-transform duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
